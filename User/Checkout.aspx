<%@ Page Title="" Language="C#" MasterPageFile="~/User/Member.master" AutoEventWireup="true" CodeFile="Checkout.aspx.cs" Inherits="User_Default" %>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left">
                                            <asp:DropDownList ID="drpbankname" runat="server" 
                                                onselectedindexchanged="drpbankname_SelectedIndexChanged">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtcardno" runat="server" MaxLength="16" Width="171px" 
                                                ontextchanged="txtcardno_TextChanged"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td style="text-align: left">
                                            <asp:TextBox ID="txtccv" runat="server" MaxLength="3" Width="68px" 
                                                ontextchanged="txtccv_TextChanged"></asp:TextBox>
                                            &nbsp;3 Digit Only</td>
                                    </tr>
                                    <tr>
                                        <td>
